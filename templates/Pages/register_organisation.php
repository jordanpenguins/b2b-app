...
/**
 *
 * @var \Cake\Collection\CollectionInterface|string[] $industries
 */
    ...
    <div class="container px-5">
        ...
        <div class="bg-light rounded-3 py-5 px-4 px-md-5 mb-5">
            <div class="text-center mb-5">
                ...
                <h1 class="fw-bolder">Registration form for organisations</h1>
                <p class="lead fw-normal text-muted mb-0">Join our network by registering your organisation</p>
            </div>
            <div class="row gx-5 justify-content-center">
                <div class="col-lg-8 col-xl-6">
                    <?= $this->Form->create(null, ['url' => ['controller' => 'Organisations', 'action' => 'register'], 'id' => 'organisationForm']) ?>
